...
use Creative8\CartRecovery\Admin\Admin;
use Creative8\CartRecovery\Email\AbandonedCart;
...
class Plugin {
	...
	public function init_components() {
		$this->tracker  = new CartTracker();
		$this->recovery = new CartRecovery();
		$this->cron     = new CronHandler();
	...
	public function register_email_class( $email_classes ) {
		$email_classes['C8CR_Email_Abandoned_Cart'] = new AbandonedCart();
